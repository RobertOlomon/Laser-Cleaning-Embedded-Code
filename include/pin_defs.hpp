...
// Chip Select Pins
constexpr static uint8_t JAW_ROTATION_CS_PIN = 255;   // Pin for jaw rotation motor
...
/* -------------------------------------------------------------------------- */
constexpr static uint8_t JAW_ROTATION_STEP_PIN = 255;   // Pin for jaw rotation step
constexpr static uint8_t JAW_ROTATION_DIR_PIN  = 255;   // Pin for jaw rotation direction
